import{getExerciseById as y,patchRating as w}from"./api-CA10J7K2.js";import{i as d}from"./icons-C9mw2FC3.js";import"./vendor-D1yz-ZLW.js";const r=document.querySelector("#exercise-modal"),v=document.querySelector(".ExercisesList");let m=null;v&&v.addEventListener("click",async t=>{const e=t.target.closest(".exercise-start-btn");if(e)try{const a=await y(e.dataset.id);a&&p(a)}catch(a){console.error(a)}});function p(t){m=t,r.innerHTML=$(t),r.classList.remove("is-hidden"),document.body.classList.add("no-scroll"),window.addEventListener("keydown",h),E(t)}function E(t){const e=document.querySelector(".btn-favorite");if(!e)return;const o=(JSON.parse(localStorage.getItem("favorites"))||[]).some(s=>s._id===t._id);g(e,o),e.addEventListener("click",()=>{const s=JSON.parse(localStorage.getItem("favorites"))||[],n=s.findIndex(i=>i._id===t._id);n!==-1?(s.splice(n,1),g(e,!1)):(s.push(t),g(e,!0)),localStorage.setItem("favorites",JSON.stringify(s))})}function g(t,e){e?t.innerHTML=`Remove from favorites <svg class="modal-heart" width="20" height="20">
...
//# sourceMappingURL=modals-OkKLT4Z3.js.map
